...
describe('useSWR - local mutation', () => {
  ...
  it('should support async mutation with promise', async () => {
    ...
    await act(() => {
      ...
      return mutate(
        'mutate-promise',
        new Promise((res) => setTimeout(() => res(999), 200)),
        false
      )
    })
  ...
  it('should support async mutation with async function', async () => {
    ...
    await act(() => {
      // mutate and revalidate
      return mutate('mutate-async-fn', fetcher, false)
    })
  ...
  it('should ignore in flight requests when mutating', async () => {
    ...
    act(() => mutate('mutate-2', 3))
    console.info(
      '*The warning "act(async () => ...) without await" here is excepted'
    )
    await 0
  ...
  it('should ignore in flight mutations when calling another async mutate', async () => {
    ...
    await act(() => mutate('mutate-3', 'on', false))
    ...
    await act(() => mutate('mutate-3', 'off', false))
